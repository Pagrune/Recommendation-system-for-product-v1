...
input_product_id = 11
input_product_title = df.loc[df['id'] == input_product_id, 'title'].values[0]

# Obtenir les recommandations pour l'ID du produit
recommendations = df_similarities.nlargest(11, input_product_id)[['id']].loc[df_similarities['id'] != input_product_id]
